...
def detect_ip_threat(ip_address):
    data = get_ip_reputation(ip_address)
    ...
    print("\n=== SOC IP Threat Detection Report ===")
    ...
    if abuse_score >= 75:
        print("[CRITICAL] Highly malicious IP detected!")
    elif abuse_score >= 25:
